...
import { Calendar, Clock, Hourglass, Tag, CreditCard, MessageCircle } from "lucide-react"
          ...
          <div className="md:col-span-7 flex flex-col items-start space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[#68718B] text-[16px] leading-relaxed max-w-md">
                {t.rich("description", {
                  tutorName: () => (
                    <span className="font-semibold text-[#11142D]">{tutorName}</span>
                  ),
                })}
                <br />
                {t("waiting")}
