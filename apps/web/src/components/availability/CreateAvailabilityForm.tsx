...
// import { FormValues , schema } from '@/schemas/availability/create-availability-schema';
// const DAYS = ['monday','tuesday','wednesday','thursday','friday','saturday','sunday'] as const;
// type Day = typeof DAYS[number];



// export default function CreateAvailabilityForm({ onClose }: { onClose: () => void }) {
...
//           <h2 className="text-lg font-bold">Set Up Your First Slot</h2>
...
export default function CreateAvailabilityForm({ onClose }: { onClose: () => void }) {
  const t = useTranslations('availability.createForm');
